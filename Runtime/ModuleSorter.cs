...
namespace AceLand.Lifecycle
{
    internal static class ModuleSorter
    {
        ...
        /// <para>This method is side-effect free: it only appends findings to <paramref name="issues"/>.
        /// Logging (if any) is the caller's responsibility, so unit tests that exercise the sorter
        /// don't leave stray error logs in the Editor Console.</para>
        /// </summary>
